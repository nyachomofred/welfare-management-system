...
<div class="member-index">
    ...
    <p>
        <?= Html::button('Add new payment',  ['value'=>Url::to('index.php?r=paymenthistory/create'),'class' => 'btn btn-link','id'=>'modalButton']) ?>
    </p>
    <?php
      Modal::begin([
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapperrr">
    ...
    <section class="content-header">
      <h1>
        Total credit ksh <?php echo $credit;?>
       
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Members credit</li>
      </ol>
    </section>
